<?php $__env->startSection('title', 'Footer - UI elements'); ?>
...
<section id="basic-footer">
  ...
  <footer class="footer bg-lighter">
    <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
      <div>
        <a href="<?php echo e(config('variables.livePreview')); ?>" target="_blank" class="footer-text fw-bold"><?php echo e(config('variables.templateName')); ?></a> ©
      </div>
      <div class="d-flex flex-column flex-sm-row">
        <a href="<?php echo e(config('variables.licenseUrl')); ?>" class="footer-link me-4" target="_blank">License</a>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\materio\html-laravel-free-internal\full-version\resources\views/content/user-interface/ui-footer.blade.php ENDPATH**/ ?>