...
<body>
    <div class="container">
        <div class="upload-form">
            ...
            <form action="{{ route('questions.upload') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
        ...
        (function() {
            ...
            window.addEventListener('load', function() {
                ...
                fileInput.addEventListener('change', function(event) {
                    ...
                    var fileName = input.files[0] ? input.files[0].name : 'Select file';
