...
<div class="d-flex justify-content-center mx-auto gap-3">
  ...
  <a href="<?php echo e(config('variables.documentation')); ?>/Icons.html" class="btn btn-primary" target="_blank">How to use icons?</a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\materio\html-laravel-free-internal\full-version\resources\views/content/icons/icons-mdi.blade.php ENDPATH**/ ?>