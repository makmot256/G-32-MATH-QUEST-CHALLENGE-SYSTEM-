<?php $__env->startSection('title', 'Perfect Scrollbar - Extended UI'); ?>
  ...
  <div class="col-md-6 col-sm-12">
    <div class="card overflow-hidden mb-4" style="height: 300px;">
      ...
      <div class="card-body" id="horizontal-example">
        <img src="<?php echo e(asset('assets/img/backgrounds/18.jpg')); ?>" alt="scrollbar-image" />
      </div>
    </div>
  </div>
  <!--/ Horizontal Scrollbar -->
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\materio\html-laravel-free-internal\full-version\resources\views/content/extended-ui/extended-ui-perfect-scrollbar.blade.php ENDPATH**/ ?>