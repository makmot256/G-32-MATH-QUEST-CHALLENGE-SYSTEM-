                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize"><b>Challenges done today</b></p>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize"><b>Today's Participants</b></p>
                                <h4 class="mb-0">100</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize"><b>New participants</b></p>
                                <h4 class="mb-0">54</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
