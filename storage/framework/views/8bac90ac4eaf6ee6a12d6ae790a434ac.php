...
<div class="row mb-5">
  ...
  <div class="col-md-6 col-lg-4 mb-3">
    <div class="card h-100">
      ...
      <img class="img-fluid" src="<?php echo e(asset('assets/img/elements/13.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
...
<div class="row mb-5">
  <div class="col-md-6 col-xl-4">
    <div class="card mb-3">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/18.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">
  ...
  <div class="col-md-6 col-xl-4">
    <div class="card bg-dark border-0 text-white">
      <img class="card-img" src="<?php echo e(asset('assets/img/elements/11.jpg')); ?>" alt="Card image" />
...
<div class="row mb-5">
  <div class="col-md">
    <div class="card mb-3">
      <div class="row g-0">
        <div class="col-md-4">
          <img class="card-img card-img-left" src="<?php echo e(asset('assets/img/elements/12.jpg')); ?>" alt="Card image" />
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
  ...
  <div class="col-md">
    <div class="card mb-3">
      <div class="row g-0">
        ...
        <div class="col-md-4">
          <img class="card-img card-img-right" src="<?php echo e(asset('assets/img/elements/17.jpg')); ?>" alt="Card image" />
        </div>
      </div>
    </div>
  </div>
...
<div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
  ...
  <div class="col">
    <div class="card h-100">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/19.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
  ...
  <div class="col">
    <div class="card h-100">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/20.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
...
<div class="row" data-masonry='{"percentPosition": true }'>
  ...
  <div class="col-sm-6 col-lg-4 mb-4">
    <div class="card">
      <img class="card-img" src="<?php echo e(asset('assets/img/elements/4.jpg')); ?>" alt="Card image cap" />
    </div>
  </div>
  <div class="col-sm-6 col-lg-4 mb-4">
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\materio\html-laravel-free-internal\full-version\resources\views/content/cards/cards-basic.blade.php ENDPATH**/ ?>